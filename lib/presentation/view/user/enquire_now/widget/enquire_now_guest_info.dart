...
class EnquireNowGuestInfo extends StatelessWidget {
  final EnquireNowController controller;

  const EnquireNowGuestInfo({super.key, required this.controller});
          ...
          child: Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  '${controller.guestCount} GUEST${controller.guestCount > 1 ? 'S' : ''}',
