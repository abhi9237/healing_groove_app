...
class BookProgramRepository {
  final ApiCall _apiCall = ApiCall();

  Future<Response> getSeatAvailability(int id) async {
    log('AuthRepository: Endpoint is ${ApiConstant.seatAvailability}');

    try {
      final response = await _apiCall.getRequest(
        endPoint: "${ApiConstant.seatAvailability}$id",
